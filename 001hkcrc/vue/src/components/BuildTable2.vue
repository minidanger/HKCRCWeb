    ...
    <el-dialog title="新增信息" v-model="dialogVisible" width="30%">
      <el-form :model="form"  label-width="120px">
        <el-form-item label="石矢单编号">
          <el-input v-model="form.docket" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="地点">
          <el-input v-model="form.site" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="地点">
          <el-input v-model="form.location" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="车牌号码">
          <el-input v-model="form.truck" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="离槽时间">
          <el-input v-model="form.despatch" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="到场地时间">
          <el-input v-model="form.arrival" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="场地">
          <el-input v-model="form.batch" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="载量">
          <el-input v-model="form.load" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="总埋槽量">
          <el-input v-model="form.sum" style="width: 80%"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(id){
      request.delete("/api/truck/"+id).then(res => { //es6语法
        console.log(res)
        if(res.code ==='0' )
        {
          this.$message({
    ...
    save(){
      if(this.form.id)
      {
        ...
        request.put("/api/truck",this.form).then(res => { //es6语法
          console.log(res)
          if(res.code ==='0' )
          {
            this.$message({
        ...
        request.post("/api/truck",this.form).then(res => { //es6语法
          console.log(res)
          if(res.code ==='0' )
          {
            this.$message({
